...
<section id="about">
  <div class="section-head reveal">
    ...
    <p class="section-desc">Engineer by training, builder by instinct. I turn fuzzy business problems into deployable AI systems and automation pipelines that hold up in production.</p>
  </div>
  ...
  <div class="about-grid">
    ...
    <div class="about-body reveal">
      ...
      <p>My sweet spot: <b>LLM-powered agents &middot; workflow automation &middot; predictive analytics &middot; cloud deployment</b>. If a manual process is draining your team's time, I can usually turn it into a reliable automated system.</p>
